            ...
            <v-col md="5">
              ...
              >
                ...
                <v-date-picker v-model="deadline" no-title scrollable>
                  ...
                  <v-btn color="primary" @click="$refs.menu.save(deadline)">OK</v-btn>
                </v-date-picker>
              </v-menu>-->
            </v-col>
          </v-row>
...
export default {
  ...
  data() {
    return {
      ...
      chips: [],
      categorys: ["Sport", "Travel", "Food & Drink", "2Tek", "Social"],
  ...
  mounted(){
    this.content = '<p>Ghi cai nay vao content ok gi roi lam gi tiep gio</p><figure class="image"><img src="https://firebasestorage.googleapis.com/v0/b/contento-admin.appspot.com/o/images%2Fcontent%2Fa.png?alt=media&amp;token=2860ba48-8ee3-41ab-8c5e-96b935d65d51"></figure>"';
  }
};
</script>
<style scoped>
